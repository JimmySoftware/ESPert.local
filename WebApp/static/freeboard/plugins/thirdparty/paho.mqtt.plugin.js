...
(function()
{
	...
	freeboard.loadDatasourcePlugin({
		...
		"external_scripts" : [
			"http://www.tespa.io/freeboard/js/mqttws31.js"
		],
		"settings"    : [
			{
				"name"         : "server",
	...
	var mqttDatasourcePlugin = function(settings, updateCallback)
	{
		...
		self.publichMessage = function(newSettings, msg)
		{
			if (!client.isConnected()) {
				client.connect({onSuccess:onConnect,
								userName: newSettings.username,
								password: newSettings.password,
								useSSL: newSettings.use_ssl});
			}
			client.send( currentSettings.topic, msg, 0, false );
		}
